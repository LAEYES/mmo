...
import './styles.css';
import { canEnterZone, canWalkTile, explore, findTilePath, getNearestPoi, getReachableZones, getZone, getZoneStatus, getTile, moveTile, zones } from './world';
