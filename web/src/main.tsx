...
import './styles.css';
import { canEnterZone, canWalkTile, explore, getNearestPoi, getReachableZones, getZone, getZoneStatus, getTile, moveTile, zones } from './world';
